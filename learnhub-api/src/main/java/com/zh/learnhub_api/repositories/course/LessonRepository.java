...
public interface LessonRepository extends JpaRepository<Lesson, Long> {
    ...
    @Query("SELECT l FROM Lesson l JOIN FETCH l.courseId WHERE l.id = :lessonId")
    ...
    @Query(value = """
        ...
        WHERE l.id = :lessonId
        """, nativeQuery = true)
    Optional<LessonAccessProjection> findLearningAccess(@Param("lessonId") Long lessonId, @Param("userId") Long userId);
    ...
    interface CourseLessonCountProjection {
        Long getCourseId();
