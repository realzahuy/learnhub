...
public interface UserSessionRepository extends JpaRepository<UserSession, Long> {
    ...
    @Query(value = "SELECT us.id AS sessionId, us.refresh_token_hash AS refreshTokenHash, "
           ...
           nativeQuery = true)
    Optional<SessionRefreshProjection> findRefreshSessionById(
    ...
    Optional<SessionAuthenticationProjection> findAuthenticationById(
            @Param("sessionId") Long sessionId);
