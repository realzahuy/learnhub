...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    @Query(value = """
        SELECT n.id AS id, n.type AS type, n.title AS title, n.content AS content,
               n.course_id AS courseId, n.read_at AS readAt, n.created_at AS createdAt
        FROM notification n
    ...
    List<NotificationPageRow> findFirstNotificationPage(
            @Param("recipientId") Long recipientId, @Param("limit") int limit);
