...
public class PublishedVideoPlaybackCacheService {
    ...
    @Cacheable(cacheNames = CacheConfiguration.PUBLISHED_VIDEO_PLAYBACK, key = "#videoId", sync = true)
    public PublishedVideoPlayback getReadyPublishedVideo(Long videoId) {
        ...
        return new PublishedVideoPlayback(video.getCourseId(), video.getStorageKey(), video.isLessonPreview());
    }

    public record PublishedVideoPlayback(Long courseId, String storageKey, boolean lessonPreview) {}
}
