...
public class MediaConvertTranscoder {
    ...
    public String createHlsTranscodingJob(String inputObjectKey, String outputPath, String clientRequestToken) {
    ...
    public void cancelJob(String jobId) {
        mediaConvertClient.cancelJob(CancelJobRequest.builder().id(jobId).build());
    }
    ...
    private JobSettings buildJobSettings(String inputUri, String outputUri) {
        ...
        Input input = Input.builder()
                ...
                .videoSelector(VideoSelector.builder().rotate(InputRotate.AUTO).build())
                .build();
        ...
        return JobSettings.builder().inputs(input).outputGroups(outputGroup).build();
    }
